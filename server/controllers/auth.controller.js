  ...
  const html = `
    <div style="font-family: 'Segoe UI', sans-serif; max-width: 560px; margin: 0 auto; background: #0a0a10; border-radius: 16px; overflow: hidden; border: 1px solid rgba(255,107,53,0.2);">
      <div style="background: linear-gradient(135deg, #ff6b35, #f59e0b); padding: 32px; text-align: center;">
        <h1 style="color: #fff; margin: 0; font-size: 28px; letter-spacing: -1px;">🔐 LostFound</h1>
      ...
      <div style="padding: 36px 32px;">
        ...
        <p style="color: rgba(255,255,255,0.6); font-size: 15px; line-height: 1.6; margin: 0 0 28px;">
          We received a request to reset the password for your Bennett LostFound account. Click the button below to create a new password. This link expires in <strong style="color:#f59e0b;">1 hour</strong>.
        </p>
      ...
      <div style="background: rgba(255,255,255,0.03); padding: 16px; text-align: center; border-top: 1px solid rgba(255,255,255,0.05);">
        <p style="color: rgba(255,255,255,0.2); font-size: 11px; margin: 0;">LostFound • Bennett University Campus Network</p>
      </div>
    </div>
  `;

  try {
    await sendEmail({ to: user.email, subject: '🔐 Reset Your LostFound Password', html });
